    ...
    if request.method == "POST" :
        ...
        if res is not None :
            ...
            if res['user_type'] == "admin" :
                ...
                return render_template("loginform.html", alert_message="Unknown user type.")
        else:
             return render_template("loginform.html", alert_message="Invalid username or password.")
    else :
...
def testresult() :
    if session['log'] == "log":
            ...
            try:
                ...
                plt.savefig(r"C:\Users\dwaip\Desktop\Project\Career-Prediction\sample.jpg")
...
def eqtest():
    if session['log'] == "log":
        ...
        if request.method == "POST":
            ...
            print(ss,"====")
            if ss is not None:
                return "<script>alert('You Already Completed your test!!!');window.location='/predict'</script>"
