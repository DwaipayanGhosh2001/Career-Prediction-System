...
def traing():
    # training_data = np.loadtxt(r"C:\Users\dwaip\Desktop\Project\Career-Prediction\train.txt", dtype=str, delimiter=" ")
    training_data = np.loadtxt(r"C:\Users\dwaip\Desktop\Project\Career-Prediction\train.txt", dtype=str, delimiter=" ", usecols=range(15))
